@include('common/header_link')
    ...
    <div class="bog_content">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-9">
                    <div class="page-header" style="margin-bottom: 24px; padding: 18px 22px; background: #f5f9f7; border: 1px solid #dcdfe0; border-radius: 6px;">
                        <h2 style="margin: 0; font-size: 24px; color: #1f5c44;"><i class="fa fa-hockey-puck"></i> Hockey Betting</h2>
                        <p style="margin: 8px 0 0; color: #58606a; font-size: 14px; max-width: 720px;">Explore the latest mock hockey matchups, choose expanded market odds and place bets with a clean pro-style interface.</p>
                    </div>
...
$(function(){
    ...
    function fetchAndRenderAll() {
        $.getJSON('{{ url('api/fixtures') }}', {sport: 'hockey', status: 'all'}, function(data) {
